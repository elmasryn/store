            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <div class="aboutus-box-score equal-elem ">
                    ...
                    <p class="desc">Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                        Lorem Ipsum has been the dummy text ever since the 1500s...</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <div class="aboutus-box-score equal-elem ">
            ...
            <div class="our-staff">
                <div class="slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false"
                    ...
                    <div class="team-member equal-elem">
                        <div class="media">
                            <a href="#" title="LEONA">
                                <figure><img src="frontend/images/member-leona.jpg" alt="LEONA"></figure>
                            </a>
                        </div>
                        <div class="info">
                    ...
                    <div class="team-member equal-elem">
                        <div class="media">
                            <a href="#" title="LUCIA">
                                <figure><img src="frontend/images/member-lucia.jpg" alt="LUCIA"></figure>
                            </a>
                        </div>
                        <div class="info">
                    ...
                    <div class="team-member equal-elem">
                        <div class="media">
                            <a href="#" title="NANA">
                                <figure><img src="frontend/images/member-nana.jpg" alt="NANA"></figure>
                            </a>
                        </div>
                        <div class="info">
                            <b class="name">NANA</b>
                    ...
                    <div class="team-member equal-elem">
                        <div class="media">
                            <a href="#" title="BRAUM">
                                <figure><img src="frontend/images/member-braum.jpg" alt="BRAUM"></figure>
                            </a>
                        </div>
                        <div class="info">
                    ...
                    <div class="team-member equal-elem">
                        <div class="media">
                            <a href="#" title="NANA">
                                <figure>
                                    <img src="frontend/images/member-nana.jpg" alt="NANA">
                                </figure>
                            </a>
                        </div>
                        <div class="info">
